...
function buildDragon() {
  ...
  api.update = function (dt, t, st) {
    ...
    for (var wi = 0; wi < 2; wi++) {
      ...
      // the wing INSIDE a turn folds while the outer one stays spread — the
      // asymmetry that makes a banked turn read as flown rather than steered
      var tuck = Math.max(0, (st.strafeX || 0) * -sgn) * 0.55;
      var eT = -fold * 0.95 + wingV * 0.028 - tuck * 0.5 - diveN * 0.40;
      var rT = -fold * 1.25 - wingV * 0.045 - tuck * 0.40 - diveN * 0.50;
